...
- Implementation: `docs/qa/implementation-submittal-builder-1204x854.png` (1189 x 843 content raster from a 1204 x 854 requested browser viewport; browser chrome and scrollbars are excluded by the capture API)
...
- Intentional differences: the optional cover-information strip and Decking category are approved requirements; the builder is embedded lower on the homepage, so the focused anchor capture does not include the site navigation.
